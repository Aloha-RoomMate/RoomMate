...
class Post {
  ...
  factory Post.fromMap(String postId, Map<String, dynamic> map) {
    return Post(
      postId: postId,
      ...
      movingDate: (map['movingDate'] as Timestamp?)?.toDate(),
  ...
  factory Post.fromDoc(DocumentSnapshot<Map<String, dynamic>> doc) {
    return Post.fromMap(doc.id, doc.data() ?? <String, dynamic>{});
  }
}
